...
#define CY_CFG_SYSCLK_CLKHF0_FREQ_MHZ 98UL
...
#define CY_CFG_SYSCLK_CLKHF2_FREQ_MHZ 49UL
...
__STATIC_INLINE void Cy_SysClk_ClkHf1Init()
{
    ...
    Cy_SysClk_ClkHfSetDivider(CY_CFG_SYSCLK_CLKHF1, CY_SYSCLK_CLKHF_DIVIDE_BY_4);
