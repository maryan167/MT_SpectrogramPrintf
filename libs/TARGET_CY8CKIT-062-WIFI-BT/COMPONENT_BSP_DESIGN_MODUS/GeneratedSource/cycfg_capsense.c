...
#define CY_CAPSENSE_WIDGET_COUNT                                                 (0u)
#define CY_CAPSENSE_SENSOR_COUNT                                                 (0u)
#define CY_CAPSENSE_ELTD_COUNT                                                   (0u)
#define CY_CAPSENSE_PIN_COUNT                                                    (0u)
#define CY_CAPSENSE_SHIELD_PIN_COUNT                                             (0u)
#define CY_CAPSENSE_POSITION_SIZE                                                (0u)
#define CY_CAPSENSE_DEBOUNCE_SIZE                                                (0u)
...
static const cy_stc_capsense_common_config_t cy_capsense_commonConfig =
{
    ...
    .csdIdacAutocalEn = CY_CAPSENSE_DISABLE,
